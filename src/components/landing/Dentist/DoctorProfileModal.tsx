...
// 🔑 FIX 1: Use the complex type structure to maintain compatibility with DentistList.tsx
type Doctor = {
    id: string;
    name: string;
    specialization: string;
    education: string;
    image?: { src: string } | string; // ⬅️ CRITICAL FIX: Accepts the imported image object
    bio?: string;
    years: number;
    philosophy: string;
    affiliations: string;
